...
## Project Structure
    ...
    ├── drop_track_music_38083  # Django project configurations
...
1. Clone this repo and `cd drop_track_music_38083`
...
2. Clone this repo and `cd drop_track_music_38083`
